...
urlpatterns = [
    ...
    # PASSWORD RESET (routes personnalisées)
    # Password reset - vues personnalisées + alias attendu par les templates d'origine
    path(
        'mot-de-passe-oublie/',
        auth_views.PasswordResetView.as_view(
            ...
            success_url=reverse_lazy('password_reset_done_custom'),
        ),
    ...
    # confirmation : on expose aussi le nom 'password_reset_confirm' (alias) pour être compatible
    path(
        ...
        name='password_reset_confirm'  # alias demandé par certains templates/email
    ),
    path(
